...
| **BigBattery** | **Step 1 (application submitted, awaiting BigBattery's review)** | Fully submitted 2026-08-20 with zero fabrication — confirmed via BigBattery's own "Application received" message. Waiting on their review; no owner action needed unless they follow up asking for something GridPermit genuinely doesn't have (e.g. business/legal-entity details). |
