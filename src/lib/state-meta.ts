...
export const STATE_META: Record<string, StateMeta> = {
	...
	AL: { code: "AL", name: "Alabama", slug: "alabama" },
	MT: { code: "MT", name: "Montana", slug: "montana" },
	ND: { code: "ND", name: "North Dakota", slug: "north-dakota" },
	...
	MO: { code: "MO", name: "Missouri", slug: "missouri" },
	NE: { code: "NE", name: "Nebraska", slug: "nebraska" },
};
